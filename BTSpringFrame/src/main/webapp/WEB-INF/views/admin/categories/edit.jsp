    ...
    <section class="row">
        <div class="col-6 offset-3 mt-4">
            <div class="card">
                ...
                <div class="card-body">
                    <%-- Sử dụng form:form với modelAttribute là category (đã được nạp từ controller) --%>
                    <form:form action="${pageContext.request.contextPath}/admin/categories/saveOrUpdate" method="POST" modelAttribute="category">
                        <div class="mb-3">
                            ...
                            <form:input type="text" readonly="true" class="form-control" id="id" path="id" aria-describedby="categoryIdid" placeholder="Category Id"/>
                            <%-- Lỗi ID không hiển thị vì là readonly --%>
                        </div>
                        <div class="mb-3">
